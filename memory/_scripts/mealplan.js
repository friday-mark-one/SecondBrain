...
module.exports = {
  WEEKDAYS,
  // pure helpers
  extractWikiLinks, parsePlanDishes, parseItemLines, parseIngredients,
  aggregate, renderBreakdown, groupByStore,
  renderGroceryList, extractCheckedItems, preserveChecks,
  listSlots, insertDishUnderSlot, buildPlanSkeleton, archiveStaplesSplit,
  // adapters
  generateGroceryList, toggleGroceryDetail, addDishToPlan, newWeeklyPlan, archiveAndReset,
};
