...
const recipes = [
  ...
  { name: "Masala Vada", meal: ["breakfast","lunch"], cuisine: "South Indian", protein: false, fodmap: false,
    ing: [I("Channa dal","150-200g, soaked 1.5-2h"),I("Dry red chilli","6 round"),I("Garlic","10 cloves"),I("Curry leaves","10"),I("Fennel seeds","½ tsp"),I("Onion","1, finely chopped"),I("Cilantro","finely chopped"),I("Asafotida","½ tsp"),I("Green chilli","to taste"),I("Groundnut oil","for deep frying")],
    steps: ["Soak chana dal, dried red chilli, garlic, curry leaves and fennel seeds for 1.5-2 h.","Drain the water completely; coarse-grind WITHOUT adding any water.","Mix in finely chopped onion, coriander, asafotida, green chilli and salt.","Shape into vadas and deep-fry in oil till golden."] },
];
