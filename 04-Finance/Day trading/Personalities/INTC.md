...
**Movement**: typical day ±6.5% (14d ATR) | current 20d volatility is at the 88% percentile of its own history | overnight gaps ≥1% on 38% of mornings (worst single gap -24.5%) | 2-day drops ≥2.1% (enough to threaten a fresh −15% stop at ~7× leverage) happened ~70×/year.
**Trend habits**: above its 50-day average 48% of days | long-run drift +15.4%/yr over the sample.
...
**Run continuation** (after 5-day gains ≥5%, n=253, overlapping): next 5 days averaged +0.9%, positive 48% → lift vs baseline +0.3%.
**Analyst tape (12mo)**: 12 upgrades / 4 downgrades / 89 other actions.
