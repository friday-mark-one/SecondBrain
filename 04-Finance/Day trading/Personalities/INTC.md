...
**Movement**: typical day ±3.8% (14d ATR) | current 20d volatility is at the 74% percentile of its own history | overnight gaps ≥1% on 39% of mornings (worst single gap -24.5%) | 2-day drops ≥2.1% (enough to threaten a fresh −15% stop at ~7× leverage) happened ~72×/year.
**Trend habits**: above its 50-day average 48% of days | long-run drift +15.3%/yr over the sample.
...
**Dip response** (after 2-day drops ≥3%, n=259, overlapping): next 5 days averaged +0.4%, positive 47% → lift vs baseline -0.2%.
**Run continuation** (after 5-day gains ≥5%, n=259, overlapping): next 5 days averaged +0.8%, positive 48% → lift vs baseline +0.2%.
**Analyst tape (12mo)**: 13 upgrades / 4 downgrades / 93 other actions.
