...
**Movement**: typical day ±1.8% (14d ATR) | current 20d volatility is at the 8% percentile of its own history | overnight gaps ≥1% on 28% of mornings (worst single gap -7.7%) | 2-day drops ≥2.1% (enough to threaten a fresh −15% stop at ~7× leverage) happened ~48×/year.
**Trend habits**: above its 50-day average 57% of days | long-run drift +19.2%/yr over the sample.
**Baseline first** — EVERY overlapping 5-day window in this sample: +0.4%, positive 54% of the time. Read the two lines below as lift vs this, not as raw numbers.
**Dip response** (after 2-day drops ≥3%, n=150, overlapping): next 5 days averaged +1.2%, positive 62% → lift vs baseline +0.8%.
**Run continuation** (after 5-day gains ≥5%, n=166, overlapping): next 5 days averaged +0.2%, positive 54% → lift vs baseline -0.2%.
**Analyst tape (12mo)**: 3 upgrades / 1 downgrades / 148 other actions.
