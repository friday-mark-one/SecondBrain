...
**Movement**: typical day ±2.4% (14d ATR) | current 20d volatility is at the 77% percentile of its own history | overnight gaps ≥1% on 28% of mornings (worst single gap -7.7%) | 2-day drops ≥2.1% (enough to threaten a fresh −15% stop at ~7× leverage) happened ~48×/year.
**Trend habits**: above its 50-day average 59% of days | long-run drift +20.0%/yr over the sample.
