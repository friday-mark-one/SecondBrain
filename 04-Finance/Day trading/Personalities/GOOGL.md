...
**Movement**: typical day ±1.8% (14d ATR) | current 20d volatility is at the 14% percentile of its own history | overnight gaps ≥1% on 28% of mornings (worst single gap -7.7%) | 2-day drops ≥2.1% (enough to threaten a fresh −15% stop at ~7× leverage) happened ~48×/year.
**Trend habits**: above its 50-day average 58% of days | long-run drift +18.9%/yr over the sample.
...
**Dip response** (after 2-day drops ≥3%, n=149, overlapping): next 5 days averaged +1.2%, positive 62% → lift vs baseline +0.8%.
**Run continuation** (after 5-day gains ≥5%, n=166, overlapping): next 5 days averaged +0.2%, positive 54% → lift vs baseline -0.2%.
**Analyst tape (12mo)**: 3 upgrades / 1 downgrades / 149 other actions.
