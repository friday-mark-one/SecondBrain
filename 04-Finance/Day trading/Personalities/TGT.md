...
**Movement**: typical day ±2.9% (14d ATR) | current 20d volatility is at the 61% percentile of its own history | overnight gaps ≥1% on 18% of mornings (worst single gap -24.3%) | 2-day drops ≥2.1% (enough to threaten a fresh −15% stop at ~7× leverage) happened ~48×/year.
**Trend habits**: above its 50-day average 48% of days | long-run drift -4.6%/yr over the sample.
...
**Dip response** (after 2-day drops ≥3%, n=149, overlapping): next 5 days averaged +0.8%, positive 50% → lift vs baseline +0.8%.
