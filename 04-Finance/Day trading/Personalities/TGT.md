...
> The stats section is auto-refreshed by the copilot (`personality TGT`) — it describes how this stock MOVES, to calibrate stops, dip entries, and earnings-week expectations. The narrative and observations sections are maintained by hand (or Friday): append dated entries, don't rewrite history.

<!-- personality:generated:start -->
Refreshed 2026-08-30 from 5.0y of daily data (1255 days).
**Movement**: typical day ±3.0% (14d ATR) | current 20d volatility is at the 66% percentile of its own history | overnight gaps ≥1% on 18% of mornings (worst single gap -24.3%) | 2-day drops ≥2.1% (enough to threaten a fresh −15% stop at ~7× leverage) happened ~48×/year.
**Trend habits**: above its 50-day average 48% of days | long-run drift -5.2%/yr over the sample.
**Baseline first** — EVERY overlapping 5-day window in this sample: +0.0%, positive 50% of the time. Read the two lines below as lift vs this, not as raw numbers.
**Dip response** (after 2-day drops ≥3%, n=148, overlapping): next 5 days averaged +0.9%, positive 50% → lift vs baseline +0.8%.
**Run continuation** (after 5-day gains ≥5%, n=158, overlapping): next 5 days averaged -0.9%, positive 44% → lift vs baseline -0.9%.
**Analyst tape (12mo)**: 4 upgrades / 1 downgrades / 103 other actions.
...
- 2026-08-03 — AUTO: new 52-week high. Headlines: Target (TGT) Launches First Good & Gather Cookbook With 100 Recipes | Zacks Industry Outlook The TJX, Ross Stores, Target  and Dollar Tree | A Supreme Court Ruling Against Trump's Tariffs Could Trigger Up to $175 Billion in Refunds, a Potential Tailwind for Import-Heavy Retailers
- 2026-08-03 — AUTO: new 52-week high. Headlines: Target (TGT) Launches First Good & Gather Cookbook With 100 Recipes | Zacks Industry Outlook The TJX, Ross Stores, Target  and Dollar Tree | A Supreme Court Ruling Against Trump's Tariffs Could Trigger Up to $175 Billion in Refunds, a Potential Tailwind for Import-Heavy Retailers
- 2026-08-03 — AUTO: new 52-week high. Headlines: Target (TGT) Launches First Good & Gather Cookbook With 100 Recipes | Zacks Industry Outlook The TJX, Ross Stores, Target  and Dollar Tree | A Supreme Court Ruling Against Trump's Tariffs Could Trigger Up to $175 Billion in Refunds, a Potential Tailwind for Import-Heavy Retailers
- 2026-08-07 — AUTO: new 52-week high. Headlines: Kroger makes a pricing move Costco and Walmart will love | BARK Inc (BARK) (Q1 2027) Earnings Call Highlights: Subscriber Retention Surges 170bps as ... | Target Q2 results to offer key test of recovery, says UBS
- 2026-08-10 — AUTO: new 52-week high. Headlines: Target Stock: Next Stop, $166? | Consumers Seek Value, Deal With Stress During Back-to-School Shopping Season | Retail Stocks Forecasts – Walmart, Target, and Costco Consolidate Ahead of Earnings
