...
**Movement**: typical day ±5.4% (14d ATR) | current 20d volatility is at the 87% percentile of its own history | overnight gaps ≥1% on 53% of mornings (worst single gap -17.8%) | 2-day drops ≥2.1% (enough to threaten a fresh −15% stop at ~7× leverage) happened ~82×/year.
**Trend habits**: above its 50-day average 52% of days | long-run drift +22.7%/yr over the sample.
...
**Dip response** (after 2-day drops ≥3%, n=327, overlapping): next 5 days averaged +0.2%, positive 48% → lift vs baseline -0.7%.
**Run continuation** (after 5-day gains ≥5%, n=377, overlapping): next 5 days averaged +1.0%, positive 57% → lift vs baseline +0.1%.
**Analyst tape (12mo)**: 1 upgrades / 0 downgrades / 90 other actions.
