...
**Movement**: typical day ±5.3% (14d ATR) | current 20d volatility is at the 86% percentile of its own history | overnight gaps ≥1% on 53% of mornings (worst single gap -17.8%) | 2-day drops ≥2.1% (enough to threaten a fresh −15% stop at ~7× leverage) happened ~81×/year.
**Trend habits**: above its 50-day average 52% of days | long-run drift +23.8%/yr over the sample.
**Baseline first** — EVERY overlapping 5-day window in this sample: +0.8%, positive 53% of the time. Read the two lines below as lift vs this, not as raw numbers.
**Dip response** (after 2-day drops ≥3%, n=326, overlapping): next 5 days averaged +0.1%, positive 48% → lift vs baseline -0.7%.
**Run continuation** (after 5-day gains ≥5%, n=376, overlapping): next 5 days averaged +1.0%, positive 57% → lift vs baseline +0.2%.
**Analyst tape (12mo)**: 1 upgrades / 0 downgrades / 86 other actions.
