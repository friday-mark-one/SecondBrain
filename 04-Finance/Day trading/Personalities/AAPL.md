...
**Movement**: typical day ±2.3% (14d ATR) | current 20d volatility is at the 44% percentile of its own history | overnight gaps ≥1% on 19% of mornings (worst single gap -9.4%) | 2-day drops ≥2.1% (enough to threaten a fresh −15% stop at ~7× leverage) happened ~36×/year.
**Trend habits**: above its 50-day average 56% of days | long-run drift +17.9%/yr over the sample.
...
**Run continuation** (after 5-day gains ≥5%, n=135, overlapping): next 5 days averaged +0.1%, positive 54% → lift vs baseline -0.3%.
