...
**Movement**: typical day ±2.4% (14d ATR) | current 20d volatility is at the 89% percentile of its own history | overnight gaps ≥1% on 19% of mornings (worst single gap -9.4%) | 2-day drops ≥2.1% (enough to threaten a fresh −15% stop at ~7× leverage) happened ~36×/year.
**Trend habits**: above its 50-day average 57% of days | long-run drift +16.9%/yr over the sample.
...
**Analyst tape (12mo)**: 6 upgrades / 5 downgrades / 109 other actions.
