...
**Movement**: typical day ±8.8% (14d ATR) | current 20d volatility is at the 95% percentile of its own history | overnight gaps ≥1% on 52% of mornings (worst single gap -13.3%) | 2-day drops ≥2.1% (enough to threaten a fresh −15% stop at ~7× leverage) happened ~67×/year.
**Trend habits**: above its 50-day average 60% of days | long-run drift +61.3%/yr over the sample.
...
**Dip response** (after 2-day drops ≥3%, n=255, overlapping): next 5 days averaged +1.4%, positive 53% → lift vs baseline +0.1%.
