...
> The stats section is auto-refreshed by the copilot (`personality MU`) — it describes how this stock MOVES, to calibrate stops, dip entries, and earnings-week expectations. The narrative and observations sections are maintained by hand (or Friday): append dated entries, don't rewrite history.

<!-- personality:generated:start -->
Refreshed 2026-09-20 from 5.0y of daily data (1255 days).
**Movement**: typical day ±3.5% (14d ATR) | current 20d volatility is at the 61% percentile of its own history | overnight gaps ≥1% on 53% of mornings (worst single gap -13.3%) | 2-day drops ≥2.1% (enough to threaten a fresh −15% stop at ~7× leverage) happened ~67×/year.
**Trend habits**: above its 50-day average 60% of days | long-run drift +70.6%/yr over the sample.
**Baseline first** — EVERY overlapping 5-day window in this sample: +1.4%, positive 54% of the time. Read the two lines below as lift vs this, not as raw numbers.
**Dip response** (after 2-day drops ≥3%, n=259, overlapping): next 5 days averaged +1.5%, positive 54% → lift vs baseline +0.2%.
**Run continuation** (after 5-day gains ≥5%, n=360, overlapping): next 5 days averaged +1.1%, positive 53% → lift vs baseline -0.3%.
**Analyst tape (12mo)**: 3 upgrades / 1 downgrades / 157 other actions.
...
- 2026-08-31 — AUTO: crossed above its 50d average. Headlines: VGT’s $58 Billion AI Chip Concentration Could Derail Your 2027 Returns | How to Play the Micron vs. CXMT Memory-Chip War | Not Nvidia, Not AMD. Micron Could Be September's Biggest AI Winner or Loser.
- 2026-09-02 — AUTO: crossed above its 50d average. Headlines: AI Capital Spending Could Top $31 Trillion as Tech Expansion Accelerates | Micron Rises as Taiwan Workers Demand 15% Profit Pool | Is the Memory Supercycle Peak Near for Micron and SK Hynix?
- 2026-09-10 — AUTO: opening gap -3.0%. Headlines: Semiconductors Stocks Q2 Highlights: Micron (NASDAQ:MU) | S&P 500 ends down as Treasury yields rise and traders fret about inflation | Micron Drops 4.2% While China's AI Chips Reveal Its Pricing Power
- 2026-09-14 — AUTO: opening gap -7.0%; crossed below its 50d average. Headlines: Tech pulls back on AI concerns, cybersecurity takes a step up | Update: Semiconductors Help Push US Equity Indexes Lower While Benchmark Treasury Yield Hits 5% | Dow Jones Futures: Nvidia, Micron, Sandisk Dive On AI Fears; Fed Rate Hike Looms
- 2026-09-15 — AUTO: crossed above its 50d average. Headlines: Micron's AI boom just ran into an unexpected labor problem | What Would It Take For Micron Technology Stock To Keep Climbing? | 3 Artificial Intelligence (AI) Stocks That Turned $10,000 Into More Than $100,000 in 5 Years (Hint: They've All Outperformed Nvidia)
- 2026-09-17 — AUTO: opening gap +3.1%. Headlines: AMD Leads Chip Stocks Higher Amid Sector Rebound | If QQQ Repeats Its Last Decade, $100,000 at 40 Could Hit $1 Million by 52 | Micron Jumps 5.5% as Labor Claims AI's Margin Windfall
