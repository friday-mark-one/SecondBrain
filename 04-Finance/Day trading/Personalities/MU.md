...
**Movement**: typical day ±4.5% (14d ATR) | current 20d volatility is at the 65% percentile of its own history | overnight gaps ≥1% on 53% of mornings (worst single gap -13.3%) | 2-day drops ≥2.1% (enough to threaten a fresh −15% stop at ~7× leverage) happened ~67×/year.
**Trend habits**: above its 50-day average 60% of days | long-run drift +67.3%/yr over the sample.
**Baseline first** — EVERY overlapping 5-day window in this sample: +1.3%, positive 53% of the time. Read the two lines below as lift vs this, not as raw numbers.
**Dip response** (after 2-day drops ≥3%, n=257, overlapping): next 5 days averaged +1.5%, positive 54% → lift vs baseline +0.2%.
