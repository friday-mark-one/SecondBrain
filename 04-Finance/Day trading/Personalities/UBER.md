...
**Movement**: typical day ±2.9% (14d ATR) | current 20d volatility is at the 68% percentile of its own history | overnight gaps ≥1% on 33% of mornings (worst single gap -8.4%) | 2-day drops ≥2.1% (enough to threaten a fresh −15% stop at ~7× leverage) happened ~64×/year.
**Trend habits**: above its 50-day average 50% of days | long-run drift +12.9%/yr over the sample.
...
**Dip response** (after 2-day drops ≥3%, n=213, overlapping): next 5 days averaged +1.2%, positive 59% → lift vs baseline +0.8%.
**Run continuation** (after 5-day gains ≥5%, n=218, overlapping): next 5 days averaged +0.6%, positive 57% → lift vs baseline +0.1%.
