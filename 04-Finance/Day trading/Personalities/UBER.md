...
**Movement**: typical day ±3.3% (14d ATR) | current 20d volatility is at the 39% percentile of its own history | overnight gaps ≥1% on 34% of mornings (worst single gap -8.4%) | 2-day drops ≥2.1% (enough to threaten a fresh −15% stop at ~7× leverage) happened ~63×/year.
**Trend habits**: above its 50-day average 51% of days | long-run drift +13.1%/yr over the sample.
...
**Analyst tape (12mo)**: 2 upgrades / 0 downgrades / 77 other actions.
