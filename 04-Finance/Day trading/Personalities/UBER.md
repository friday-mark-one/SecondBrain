...
**Movement**: typical day ±3.2% (14d ATR) | current 20d volatility is at the 34% percentile of its own history | overnight gaps ≥1% on 33% of mornings (worst single gap -8.4%) | 2-day drops ≥2.1% (enough to threaten a fresh −15% stop at ~7× leverage) happened ~63×/year.
**Trend habits**: above its 50-day average 51% of days | long-run drift +10.1%/yr over the sample.
...
**Run continuation** (after 5-day gains ≥5%, n=215, overlapping): next 5 days averaged +0.5%, positive 57% → lift vs baseline +0.1%.
**Analyst tape (12mo)**: 2 upgrades / 0 downgrades / 73 other actions.
