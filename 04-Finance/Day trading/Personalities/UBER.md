...
> The stats section is auto-refreshed by the copilot (`personality UBER`) — it describes how this stock MOVES, to calibrate stops, dip entries, and earnings-week expectations. The narrative and observations sections are maintained by hand (or Friday): append dated entries, don't rewrite history.

<!-- personality:generated:start -->
Refreshed 2026-08-23 from 5.0y of daily data (1255 days).
**Movement**: typical day ±3.4% (14d ATR) | current 20d volatility is at the 62% percentile of its own history | overnight gaps ≥1% on 33% of mornings (worst single gap -8.4%) | 2-day drops ≥2.1% (enough to threaten a fresh −15% stop at ~7× leverage) happened ~63×/year.
**Trend habits**: above its 50-day average 50% of days | long-run drift +14.0%/yr over the sample.
**Baseline first** — EVERY overlapping 5-day window in this sample: +0.4%, positive 52% of the time. Read the two lines below as lift vs this, not as raw numbers.
**Dip response** (after 2-day drops ≥3%, n=215, overlapping): next 5 days averaged +1.3%, positive 59% → lift vs baseline +0.8%.
**Run continuation** (after 5-day gains ≥5%, n=222, overlapping): next 5 days averaged +0.6%, positive 57% → lift vs baseline +0.1%.
**Analyst tape (12mo)**: 2 upgrades / 0 downgrades / 74 other actions.
...
- 2026-08-07 — AUTO: +6.5% day (≥2× its typical range); crossed above its 50d average. Headlines: LYFT Q2 Earnings Miss, Revenues Top Estimates on Record Rides | CART Q2 Earnings Miss, Revenues Beat on GTV and Ad Growth | Why Amazon, Alphabet and Uber Keep Showing Up in the Same Billionaire Portfolios
- 2026-08-10 — AUTO: crossed above its 200d average. Headlines: Can Joby's Texas Air Taxi Flights Unlock Its Next Commercial Phase? | Is JOBY Worth Buying as Commercial Progress Meets Execution Risk? | Should You Bet on UBER Stock Following Its Q2 Earnings Beat?
