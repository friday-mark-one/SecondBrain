...
**Movement**: typical day ±5.4% (14d ATR) | current 20d volatility is at the 79% percentile of its own history | overnight gaps ≥1% on 64% of mornings (worst single gap -24.9%) | 2-day drops ≥2.1% (enough to threaten a fresh −15% stop at ~7× leverage) happened ~98×/year.
**Trend habits**: above its 50-day average 39% of days | long-run drift -3.9%/yr over the sample.
...
**Dip response** (after 2-day drops ≥3%, n=422, overlapping): next 5 days averaged +0.1%, positive 46% → lift vs baseline -0.6%.
**Run continuation** (after 5-day gains ≥5%, n=390, overlapping): next 5 days averaged +0.8%, positive 49% → lift vs baseline +0.2%.
**Analyst tape (12mo)**: 6 upgrades / 2 downgrades / 83 other actions.
