...
**Movement**: typical day ±3.3% (14d ATR) | current 20d volatility is at the 32% percentile of its own history | overnight gaps ≥1% on 52% of mornings (worst single gap -10.8%) | 2-day drops ≥2.1% (enough to threaten a fresh −15% stop at ~7× leverage) happened ~81×/year.
**Trend habits**: above its 50-day average 48% of days | long-run drift +8.4%/yr over the sample.
...
**Analyst tape (12mo)**: 3 upgrades / 1 downgrades / 97 other actions.
