...
**Movement**: typical day ±3.4% (14d ATR) | current 20d volatility is at the 37% percentile of its own history | overnight gaps ≥1% on 52% of mornings (worst single gap -10.8%) | 2-day drops ≥2.1% (enough to threaten a fresh −15% stop at ~7× leverage) happened ~81×/year.
**Trend habits**: above its 50-day average 48% of days | long-run drift +8.1%/yr over the sample.
...
**Dip response** (after 2-day drops ≥3%, n=324, overlapping): next 5 days averaged +0.5%, positive 49% → lift vs baseline -0.0%.
**Run continuation** (after 5-day gains ≥5%, n=324, overlapping): next 5 days averaged +1.4%, positive 49% → lift vs baseline +0.9%.
**Analyst tape (12mo)**: 4 upgrades / 1 downgrades / 98 other actions.
