...
**Movement**: typical day ±2.3% (14d ATR) | current 20d volatility is at the 59% percentile of its own history | overnight gaps ≥1% on 44% of mornings (worst single gap -11.2%) | 2-day drops ≥2.1% (enough to threaten a fresh −15% stop at ~7× leverage) happened ~59×/year.
**Trend habits**: above its 50-day average 61% of days | long-run drift +32.6%/yr over the sample.
...
**Dip response** (after 2-day drops ≥3%, n=183, overlapping): next 5 days averaged +1.0%, positive 58% → lift vs baseline +0.3%.
**Run continuation** (after 5-day gains ≥5%, n=223, overlapping): next 5 days averaged +0.5%, positive 54% → lift vs baseline -0.2%.
