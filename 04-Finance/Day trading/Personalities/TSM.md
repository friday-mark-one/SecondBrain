...
**Movement**: typical day ±3.7% (14d ATR) | current 20d volatility is at the 86% percentile of its own history | overnight gaps ≥1% on 44% of mornings (worst single gap -11.2%) | 2-day drops ≥2.1% (enough to threaten a fresh −15% stop at ~7× leverage) happened ~59×/year.
**Trend habits**: above its 50-day average 61% of days | long-run drift +30.3%/yr over the sample.
**Baseline first** — EVERY overlapping 5-day window in this sample: +0.6%, positive 53% of the time. Read the two lines below as lift vs this, not as raw numbers.
**Dip response** (after 2-day drops ≥3%, n=183, overlapping): next 5 days averaged +0.9%, positive 58% → lift vs baseline +0.3%.
