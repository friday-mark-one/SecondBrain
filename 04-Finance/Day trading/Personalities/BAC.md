...
**Movement**: typical day ±1.6% (14d ATR) | current 20d volatility is at the 9% percentile of its own history | overnight gaps ≥1% on 23% of mornings (worst single gap -7.7%) | 2-day drops ≥2.1% (enough to threaten a fresh −15% stop at ~7× leverage) happened ~37×/year.
**Trend habits**: above its 50-day average 57% of days | long-run drift +11.9%/yr over the sample.
...
**Run continuation** (after 5-day gains ≥5%, n=120, overlapping): next 5 days averaged +0.2%, positive 60% → lift vs baseline -0.1%.
