...
**Movement**: typical day ±2.3% (14d ATR) | current 20d volatility is at the 52% percentile of its own history | overnight gaps ≥1% on 23% of mornings (worst single gap -7.7%) | 2-day drops ≥2.1% (enough to threaten a fresh −15% stop at ~7× leverage) happened ~38×/year.
**Trend habits**: above its 50-day average 57% of days | long-run drift +10.8%/yr over the sample.
...
**Dip response** (after 2-day drops ≥3%, n=114, overlapping): next 5 days averaged -0.5%, positive 41% → lift vs baseline -0.8%.
**Run continuation** (after 5-day gains ≥5%, n=119, overlapping): next 5 days averaged +0.2%, positive 61% → lift vs baseline -0.1%.
**Analyst tape (12mo)**: 0 upgrades / 2 downgrades / 63 other actions.
