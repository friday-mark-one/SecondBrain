...
# Trading research archive (Phases 0–11 + case study, 2026-07-25/26)
...
1. No free-data, daily-latency signal class survived 11 pre-registered tests; the two real effects (PEAD, tax-loss rebound) are economically immaterial at $20k. Sub-hour event trading remains untested (needs paid intraday data — the one open door).
